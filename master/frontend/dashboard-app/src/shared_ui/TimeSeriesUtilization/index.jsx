...
} from '../../pages/gpu/utils';

// Main component for time series utilization visualization
const TimeSeriesUtilizationCard = ({
  data,
  title = "Node Memory Usage Over Time",
  icon: IconComponent = Database,
  yAxisLabel = "Node Memory Usage (GB)",
  valueKey = "memory_used",
  totalKey = "memory_total",
  showPercentageOption = true,
  showTotalLinesOption = true,
  percentageAxisLabel = "Memory Utilization (%)",
  totalUtilizationLabel = "Selected Nodes Total Utilization",
  totalCapacityLabel = "Selected Nodes Total Capacity"
}) => {
      ...
      <div className="p-6">
        ...
        <div className="mb-4 flex items-center justify-end space-x-4">
          <label className="flex items-center space-x-2">
            ...
            />
            <span className="text-sm text-slate-600">{totalUtilizationLabel}</span>
          </label>
          <label className="flex items-center space-x-2">
            <input
              type="checkbox"
            ...
            />
            <span className="text-sm text-slate-600">{totalCapacityLabel}</span>
          </label>
            ...
            <LineChart 
              ...
              >
                ...
                <YAxis 
                  ...
                  label={{
                    value: showAsPercentage ? percentageAxisLabel : yAxisLabel,
                    angle: -90,
                    position: 'insideLeft',
